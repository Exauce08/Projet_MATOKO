...
public class Etudiant extends JFrame implements ActionListener {
    ...
    private final String[] col = {"Identifiant", "Prenom", "Nom", "Contact", "Discipline", "Moyenne", "Semestre"};
    private final String[] row = new String[7];
    private final String[] semesters = {"Automne", "Printemps", "Été"};

   Etudiant() {
        super("gestion des inscriptions");
        ÉtudiantComposants();
    }

    public final void ÉtudiantComposants() {
        ...
        img = new ImageIcon(getClass().getResource("Etudiant.png"));
        this.setIconImage(img.getImage());

        f = new Font("Times New Roman", Font.BOLD, 20);
        font = new Font("Times New Roman", Font.BOLD, 36);

        label = new JLabel("Inscription des étudiants");
        label.setFont(font);
        ...
        firstNameLabel = new JLabel("Prenom:");
        ...
        updateButton = new JButton("Mettre a jour");
        ...
        preAdvisingButton = new JButton("Pre-admission");
        ...
        deptLabel = new JLabel("Discipline:");
        deptLabel.setFont(f);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == addButton) {
            if (tfId.getText().isEmpty() || tfName1.getText().isEmpty() || tfPhone.getText().isEmpty()
                ...
                JOptionPane.showMessageDialog(null, "veuillez entrer des données dans JTextField");
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Vous avez entrer une information");
                }
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Aucune ligne n'a été sélectionnée ou ligne inexistante");
            }
            ...
            if (table.getSelectedRow() < 0) {
                ...
                try {
                    try (PrintWriter writer = new PrintWriter(fq)) {
